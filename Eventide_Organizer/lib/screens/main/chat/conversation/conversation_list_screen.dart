...
import 'package:eventide_organizer_app/screens/main/chat/chats/chat_screen.dart';
    ...
    return Consumer<UserProvider>(
      builder: (context, value, child) {
        return StreamBuilder<QuerySnapshot>(
            stream:
                ChatController().getConversations(value.organizerModel!.uid),
                          ...
                          child: Row(
                            ...
                            children: [
                              Consumer<UserProvider>(
                                builder: (context, value, child) {
                                  UserModel model = UserModel.fromJason(
                                      _conversations[index].usersArray[0]);
