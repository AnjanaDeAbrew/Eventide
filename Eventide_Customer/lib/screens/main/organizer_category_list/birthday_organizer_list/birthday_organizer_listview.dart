    ...
    return Consumer<OrganizerProvider>(
      builder: (context, value, child) {
        return ListView.separated(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image:
                                    NetworkImage(value.birthdayList[index].img),
                                fit: BoxFit.cover),
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              CustomText(
                                value.birthdayList[index].name,
                                fontSize: 15,
                                color: AppColors.black,
                                textOverflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                              ),
                              CustomText(value.birthdayList[index].mobile,
                                  fontSize: 14,
                                  color: AppColors.primaryAshThree),
                              CustomText(value.birthdayList[index].address,
                                  fontSize: 15,
                                  textAlign: TextAlign.left,
                                  color: AppColors.primaryAshThree),
                            ],
            ...
            itemCount: value.birthdayList.length);
      },
    );
  }
}
