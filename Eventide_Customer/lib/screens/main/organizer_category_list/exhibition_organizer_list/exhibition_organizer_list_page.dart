...
import 'package:eventide_app/screens/main/organizer_category_list/exhibition_organizer_list/exhibition_organizer_listview.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    CustomText(
                      "Results : ${Provider.of<OrganizerProvider>(context, listen: false).exhibitionList.length}",
                      fontSize: 20,
