    ...
    return Consumer<OrganizerProvider>(
      builder: (context, value, child) {
        return ListView.separated(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(
                                    value.engagementList[index].img),
                                fit: BoxFit.cover),
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              CustomText(
                                value.engagementList[index].name,
                                fontSize: 15,
                                color: AppColors.black,
                                textOverflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                              ),
                              CustomText(value.engagementList[index].mobile,
                                  fontSize: 14,
                                  color: AppColors.primaryAshThree),
                              CustomText(value.engagementList[index].address,
                                  fontSize: 15,
                                  textAlign: TextAlign.left,
                                  color: AppColors.primaryAshThree),
                            ],
            ...
            itemCount: value.engagementList.length);
      },
    );
  }
}
