...
class _WeddingOrganizersListState extends State<WeddingOrganizersList> {
  ...
  void initState() {
    _avgRating =
        Provider.of<ReviewProvider>(context, listen: false).getAvgStarCount();
    super.initState();
  }
    ...
    return Consumer<OrganizerProvider>(
      builder: (context, value, child) {
        return ListView.separated(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image:
                                    NetworkImage(value.weddingList[index].img),
                                fit: BoxFit.cover),
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              CustomText(
                                value.weddingList[index].name,
                                fontSize: 15,
                                color: AppColors.black,
                                textOverflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                              ),
                              CustomText(value.weddingList[index].mobile,
                                  fontSize: 14,
                                  color: AppColors.primaryAshThree),
                              Container(
                                child: CustomText(
                                    value.weddingList[index].address,
                                    fontSize: 15,
                                    textAlign: TextAlign.left,
                                    color: AppColors.primaryAshThree),
                              ),
            ...
            itemCount: value.weddingList.length);
      },
    );
  }
}
