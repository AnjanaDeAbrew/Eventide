    ...
    return Consumer<OrganizerProvider>(
      builder: (context, value, child) {
        return ListView.separated(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image:
                                    NetworkImage(value.officeList[index].img),
                                fit: BoxFit.cover),
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              CustomText(
                                value.officeList[index].name,
                                fontSize: 15,
                                color: AppColors.black,
                                textOverflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                              ),
                              CustomText(value.officeList[index].mobile,
                                  fontSize: 14,
                                  color: AppColors.primaryAshThree),
                              CustomText(value.officeList[index].address,
                                  fontSize: 15,
                                  textAlign: TextAlign.left,
                                  color: AppColors.primaryAshThree),
                            ],
            ...
            itemCount: value.officeList.length);
      },
    );
  }
}
