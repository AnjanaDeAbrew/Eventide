    ...
    return Consumer<OrganizerProvider>(
      builder: (context, value, child) {
        return ListView.separated(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(
                                    value.aniversaryList[index].img),
                                fit: BoxFit.cover),
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              CustomText(
                                value.aniversaryList[index].name,
                                fontSize: 15,
                                color: AppColors.black,
                                textOverflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                              ),
                              CustomText(value.aniversaryList[index].mobile,
                                  fontSize: 14,
                                  color: AppColors.primaryAshThree),
                              CustomText(value.aniversaryList[index].address,
                                  fontSize: 15,
                                  textAlign: TextAlign.left,
                                  color: AppColors.primaryAshThree),
                            ],
            ...
            itemCount: value.aniversaryList.length);
      },
    );
  }
}
