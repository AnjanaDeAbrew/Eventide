...
import 'package:eventide_app/screens/main/organizer_category_list/aniversary_organizer_list/aniversary_organizer_listview.dart';
...
class AniversaryList extends StatefulWidget {
  const AniversaryList({super.key});
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    CustomText(
                      "Results : ${Provider.of<OrganizerProvider>(context, listen: false).aniversaryList.length}",
                      fontSize: 20,
